...
ADDON=xbmcaddon.Addon(id='plugin.video.focus')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/ip29wevu9g6h0y9/wizard.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("focus Wizard","Downloading ",'', 'Please Wait')
